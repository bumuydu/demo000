...
//    static const float defaultNoise = -20.000f;
	...
	static AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
	{
        ...
        params.push_back(std::make_unique<AudioParameterFloat>(ParameterID { nameFiltLfo,  14 }, "LFO AMT--not yet implemented!", NormalisableRange<float>(0.0f, 1.0f), defaultFiltLfo));
        params.push_back(std::make_unique<AudioParameterFloat>(ParameterID { nameAtk,  15 }, "Attack (s)",    NormalisableRange<float>(0.0f, 10.0f, 0.001f, 0.3f), defaultAtk));
        params.push_back(std::make_unique<AudioParameterFloat>(ParameterID { nameDcy,  16 }, "Decay (s)",     NormalisableRange<float>(0.0f, 10.0f, 0.001f, 0.3f), defaultDcy));
        params.push_back(std::make_unique<AudioParameterFloat>(ParameterID { nameSus,  17 }, "Sustain (amp)", NormalisableRange<float>(0.0f, 1.00f, 0.010f, 0.5f), defaultSus));
        params.push_back(std::make_unique<AudioParameterFloat>(ParameterID { nameRel,  18 }, "Release (s)",   NormalisableRange<float>(0.0f, 10.0f, 0.001f, 0.3f), defaultRel));
