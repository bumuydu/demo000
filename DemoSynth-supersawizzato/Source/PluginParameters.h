...
namespace Parameters
{
	...
	static AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
	{
        ...
        params.push_back(std::make_unique<AudioParameterChoice>(ParameterID { nameLfoWf, 16 }, "LFO Waveform", StringArray{"Sinusoidal","Triangular","Saw Up","Square"/*,"Stepped S&H"*/}, defaultLfoWf));
